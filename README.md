...
Microsoft Excel – for data cleaning, cohort tables, and basic analysis
Python (optional) – for advanced churn metrics and cohort calculations
Power BI – for retention dashboards and business storytelling
...
Widely used dataset with customer demographics, services, and churn status.
📦 SaaS Subscription Churn Dataset (Kaggle)
https://www.kaggle.com/datasets/andrewmvd/churn-dataset-for-telecom-companies
Useful for cohort analysis, retention metrics, and churn prediction.
📈 Customer Analytics Dataset
https://www.kaggle.com/datasets/mkechinov/ecommerce-behavior-data-from-multi-category-store.
# Conclusion:
Customer churn is primarily driven by short-term contracts, higher monthly charges, fiber optic service usage, and electronic check payments. Improving long-term plans, pricing strategies, and early customer engagement can significantly enhance retention.
